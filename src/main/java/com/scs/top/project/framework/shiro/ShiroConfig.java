...
import com.isoftstone.pmit.common.exception.OverallExceptionHandler;
import com.isoftstone.pmit.common.util.PropertyUtil;
import com.isoftstone.pmit.common.util.StringUtils;
import com.isoftstone.pmit.framework.shiro.kickoutfilter.KickoutSessionFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //信息安全模块
        filterMap.put("/project/ism/**", "anon");
        //voc模块
        filterMap.put("/project/voc/**", "anon");
        filterMap.put("/project/restvoc/**", "anon");
        //rest
